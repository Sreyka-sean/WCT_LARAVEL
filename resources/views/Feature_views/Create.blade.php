<!-- filepath: c:\Users\user\Desktop\laravel_wct\resources\views\Feature_views\Create.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-center">Create Feature</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <!-- Create Form -->
                        <form method="POST" action="{{ route('Feature_views.store') }}" enctype="multipart/form-data">
                            @csrf
                            <!-- Name Field -->
                            <div class="mb-3">
